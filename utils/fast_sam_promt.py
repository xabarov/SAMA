...
class FastSAMPrompt:
    ...
    def box_prompt(self, bbox):
        ...
        if self.results[0].masks is not None:
            ...
            return torch.tensor(np.array([masks[max_iou_index].cpu().numpy()]))
        # return self.results
            ...
            for annotation in masks:
                ...
                for i, point in enumerate(points):
                    ...
                    if mask[point[1], point[0]] == 1 and pointlabel[i] == 0:
                        onemask -= mask
            onemask = onemask >= 1
            return torch.tensor(np.array([onemask]))
        # return self.results
    ...
    def text_prompt(self, text):
        ...
        if self.results[0].masks is not None:
            ...
            return torch.tensor(np.array([annotations[max_idx]['segmentation']]))
        # return self.results
