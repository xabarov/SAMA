...
def detect(image: np.ndarray, model: Model, min_conf_threshold: float = 0.25,
           nms_iou_threshold: float = 0.7, nc=12):
    """
    ...
    detections = postprocess(pred_boxes=boxes, input_hw=input_hw, orig_img=image, pred_masks=masks,
                             min_conf_threshold=min_conf_threshold, nms_iou_threshold=nms_iou_threshold, nc=nc)
    return detections
...
def inference_aes():
    ...
    print(seg_compiled_model.get_property('rt_info'))

    label_map = {0: 'ro_pf', 1: 'ro_sf', 2: 'mz_v', 3: 'mz_ot', 4: 'ru_ot', 5: 'bns_ot', 6: 'gr_b', 7: 'gr_vent_kr',
                 8: 'gr_vent_pr', 9: 'gr_b_act', 10: 'discharge', 11: 'diesel'}
    ...
    im = Image.fromarray(image_with_masks)
    im.show()
