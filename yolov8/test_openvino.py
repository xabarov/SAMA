...
from utils.timeit import time_function
...
def inference_yolo():
    ...
    DET_MODEL_NAME = "D:\python\\aia_git\\ai_annotator\yolov8\weights\\best.pt"
    ...
    print(f'Took {total_time:.8f} seconds')
...
# det_model_path = Path(f"yolo_openvino_model/yolo.xml")
