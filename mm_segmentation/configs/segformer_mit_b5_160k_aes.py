...
data_preprocessor = dict(
    ...
    mean=[103.68238594, 115.12355758, 111.36336727],
    std=[45.7925291, 46.47562911, 51.79538171],
    bgr_to_rgb=True,
    pad_val=0,
    seg_pad_val=255,
    size=(640, 640))
model = dict(
    ...
    data_preprocessor=dict(
        ...
        seg_pad_val=255,
        size=(640, 640)),
    pretrained='pretrained/segformer_mit-b5_640x640.pth',
    backbone=dict(
...
dataset_type = 'AesDataset'
data_root = 'D:/python/mm_seg2/data/aes_mmseg_without_turbine'
crop_size = (640, 640)
train_pipeline = [
...
launcher = 'none'
work_dir = './work_dirs\\segformer_mit_b5_160k_aes'
